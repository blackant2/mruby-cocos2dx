...
LOCAL_SRC_FILES = %w(CCActionFrame
CCActionFrameEasing
CCActionManagerEx
CCActionNode
CCActionObject
...
WidgetReader/ButtonReader/ButtonReader
WidgetReader/CheckBoxReader/CheckBoxReader
WidgetReader/ImageViewReader/ImageViewReader
WidgetReader/LayoutReader/LayoutReader
WidgetReader/ListViewReader/ListViewReader
WidgetReader/LoadingBarReader/LoadingBarReader
WidgetReader/PageViewReader/PageViewReader
WidgetReader/ScrollViewReader/ScrollViewReader
WidgetReader/SliderReader/SliderReader
WidgetReader/TextAtlasReader/TextAtlasReader
WidgetReader/TextBMFontReader/TextBMFontReader
WidgetReader/TextFieldReader/TextFieldReader
WidgetReader/TextReader/TextReader
ActionTimeline/CCNodeReader
ActionTimeline/CCActionTimelineCache
ActionTimeline/CCFrame
ActionTimeline/CCTimeLine
ActionTimeline/CCActionTimeline)
...
LOCAL_SRC_FILES.each do |f|
   ...
   sh="#{CC} -MMD -MP -MF objs/#{LIB_NAME}/#{f}.o.d"
		...
		sh<<" -I#{COCOS_ROOT}/cocos/editor-support/cocostudio/../../../external"
		sh<<" -I#{COCOS_ROOT}/cocos/editor-support/cocostudio/.."
		sh<<" -I#{COCOS_ROOT}/cocos/editor-support/cocostudio/../.."
		...
		sh<<" -I#{COCOS_ROOT}/cocos/ui/.."
		sh<<" -I#{COCOS_ROOT}/cocos/ui/../editor-support"
		...
		sh<<" -c  #{COCOS_ROOT}/cocos/editor-support/cocostudio/#{f}.cpp"
