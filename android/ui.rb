...
LOCAL_SRC_FILES.each do |f|
	  		 ...
	  		 sh<<" -I#{COCOS_ROOT}/cocos/ui/../../external"
	  		 sh<<" -I#{COCOS_ROOT}/cocos/ui/.." 
	  		 sh<<" -I#{COCOS_ROOT}/cocos/ui/../.." 
	  		 ...
	  		 sh<<" -fexceptions   -frtti -DCC_ENABLE_CHIPMUNK_INTEGRATION=1 -fsigned-char -DNDEBUG " 
	  		 sh<<" -I#{NDK_ROOT}/platforms/android-14/arch-arm/usr/include"
	  		 sh<<" -c #{COCOS_ROOT}/cocos/ui/#{f}.cpp"
