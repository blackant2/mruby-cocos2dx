...
LOCAL_SRC_FILES = %w(cddSimpleAudioEngine
ccdandroidUtils
jni/cddandroidAndroidJavaEngine)
...
LOCAL_SRC_FILES.each do |f|
  ...
  sh<<" -gcc-toolchain #{NDK_ROOT}/toolchains/arm-linux-androideabi-4.8/prebuilt/linux-x86_64"
		...
		sh<<" -I/#{COCOS_ROOT}/cocos/audio/android/../.."
		sh<<" -I/#{COCOS_ROOT}/cocos/audio/android/../../platform/android"
		...
		sh<<" -c  /#{COCOS_ROOT}/cocos/audio/android/#{f}.cpp"
