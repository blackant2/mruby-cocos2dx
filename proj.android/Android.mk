...
LOCAL_SRC_FILES := ../manual/RubyEngine.cpp \
          ...
          ../mruby-java/jre_mruby_ext.cpp \
          ../mruby-io/src/io.c \
          ../mruby-io/src/file.c \
          ../mruby-io/src/file_test.c \
          ../mruby-io/src/dir.c \
          ../mruby-io/gem_init.c \
          ../mruby-curl/src/http_parser.c \
          ../mruby-curl/src/mrb_http.c \
          ../mruby-curl/src/mrb_curl.c \
          ../mruby-unzip/unzip.cpp \
          ../mruby-thread/src/mrb_thread.c \
...
LOCAL_CPPFLAGS := -DCC_ENABLE_SCRIPT_BINDING_MEMORY_CONTROL=1
LOCAL_EXPORT_CPPFLAGS := -DCC_ENABLE_SCRIPT_BINDING_MEMORY_CONTROL=1
...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../../../../external/ruby/mruby \
                    ...
                    $(LOCAL_PATH)/../mruby-io/include \
                    $(LOCAL_PATH)/../mruby-curl/include \
                    $(LOCAL_PATH)/../mruby-java \
                    $(LOCAL_PATH)/../../../2d \
                    $(LOCAL_PATH)/../../../3d \
                    $(LOCAL_PATH)/../../../network \
